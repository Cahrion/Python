...
# result = pandas_series[['a','c','e']] # olmayan NaN işareti gelir.
# result = pandas_series.ndim
# result = pandas_series.dtype
# result = pandas_series.shape
# result = pandas_series.sum # Elaman sayısını toplar.
