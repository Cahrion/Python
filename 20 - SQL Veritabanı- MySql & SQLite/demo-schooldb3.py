...
"""
def UpdatingID(id,name,surname,birthdates,gender):
    cursor = connection.cursor()

    sql = 'Update student Set Name=%s, Surname=%s, Birthdate=%s, Gender=%s where idStudent=%s'
    values = (name,surname,birthdates,gender,id)
...
def UpdatingPowerID():
    ids = int(input('Witch change ID: '))
    names = input('New name: ')
    surnames = input('New surnames: ')
    birthdate = input('New Birthdate (10/10/2010)\n ')
    birthdates = birthdate.split('/')
    Gender = input('New Gender: ')
    UpdatingID(ids,names,surnames,datetime(int(birthdates[2]),int(birthdates[1]),int(birthdates[0])),Gender)
...
def UpdatingGEN(gender,name,surname,birtdates):
    cursor = connection.cursor()

    sql = 'Update student Set Name=%s, Surname=%s, Birthdate=%s where Gender=%s'
    values = (name,surname,birtdates,gender)
...
def UpdatingPowerGEN():
    genders = input('Witch change Gender (E/K): \n ')
    names = input('New name: ')
    surnames = input('New surnames: ')
    birthdate = input('New Birthdate (10/10/2010)\n ')
    birthdates = birthdate.split('/')
    UpdatingGEN(genders,names,surnames,datetime(int(birthdates[2]),int(birthdates[1]),int(birthdates[0])))
